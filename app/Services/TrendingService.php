...
class TrendingService
{
    ...
    const HASHTAG_TREND_THRESHOLD = 5; // Minimum posts in last 24h
    const POST_TREND_THRESHOLD = 10; // Minimum engagement score
    const USER_TREND_THRESHOLD = 100; // Minimum followers for trending users
